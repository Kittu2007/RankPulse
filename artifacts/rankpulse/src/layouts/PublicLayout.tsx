...
function TopNav() {
  return (
    <nav className="flex items-center justify-between px-10 py-4 border-b-2 border-[var(--black)] bg-[var(--bg)]">
      <Link href="/" className="font-black text-lg tracking-[2px] uppercase" style={{ fontFamily: 'var(--font-d)' }}>
