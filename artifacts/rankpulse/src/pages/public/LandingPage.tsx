    ...
    <div className="page-transition">
      ...
      <div className="flex flex-col lg:grid border-b-2 border-[var(--black)]" style={{ gridTemplateColumns: "1fr 340px", minHeight: "420px" }}>
        ...
        <div className="flex flex-col bg-[var(--black)]">
          ...
          <Link href="/signup" className="px-4 py-3 bg-[var(--red)] cursor-pointer flex justify-between items-center">
      ...
      <div className="grid grid-cols-3 border-t-2 border-[var(--black)]">
        {[
          ...
          <div key={f.title} className={`p-7 px-6 border-r-2 border-b-2 border-[var(--black)] ${(i + 1) % 3 === 0 ? "!border-r-0" : ""} ${i >= 6 ? "!border-b-0" : ""}`}>
            <div className="w-9 h-9 border-2 border-[var(--black)] flex items-center justify-center text-lg mb-3.5 bg-white">{f.icon}</div>
